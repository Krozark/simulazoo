...
class SimulazooPrompt(cmd2.Cmd):
    """
    Interact with the complete project through a prompt.
    """
    ...
    # enclosure function arguments parser
    ...
    # load_config|do_load function arguments parser
